package com.devonfw.application.tptf.general.common.impl.security;
...
public class CsrfRequestMatcher implements RequestMatcher {
  ...
  private static final Pattern HTTP_POST_METHOD_PATTERN = Pattern.compile("^POST$");

  private static final Pattern HTTP_PUT_METHOD_PATTERN = Pattern.compile("^PUT$");

  private static final Pattern HTTP_DELETE_METHOD_PATTERN = Pattern.compile("^DELETE$");
  ...
  public boolean matches(HttpServletRequest request) {
    ...
    if (HTTP_POST_METHOD_PATTERN.matcher(request.getMethod()).matches()) {

      return false;
    }
    if (HTTP_PUT_METHOD_PATTERN.matcher(request.getMethod()).matches()) {

      return false;
    }
    if (HTTP_DELETE_METHOD_PATTERN.matcher(request.getMethod()).matches()) {
